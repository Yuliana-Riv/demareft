<template >
    <div id="AddUsr">
        ...
        <div class="form-content">
            <form @submit.prevent="
                submit(
                 name , lastname, role, email, phone, pass,passc
                )
              ">
                ...
                <div class="option-btn" @click="role = 'admin'">admin</div>
                    ...
                    <div class="grup-form dflx">
                        <div class="boxform">
                            ...
                            <input v-model="phone" type="text" id="phone" name="phone" minlength="10" maxlength="10" size="10" pattern="\d*" required class="in1">
                        </div>
                        <div class="boxform">
