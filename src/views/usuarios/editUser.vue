<template >
    <div id="EditUsr">
            ...
            <form @submit.prevent="
                submit(
                 added.name , added.lastname, added.role, added.email, added.phone, pass,  passc
                )
              ">
                     ...
                     <div class="grup-form dflx">
                        ...
                        <div class="boxform">
                            ...
                            <input v-model="added.lastname" type="text" id="lastname" name="lastname"  pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ0-9\s]{2,254}" required class="in1">
                        </div>
                        <div class="boxform">
                          ...
                          <div class="select-container">
                                ...
                                <div class="options-cont" @click="closeSelect()">
                                    <div class="option-btn" @click="added.role = 'admin'">admin</div>
                                </div>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="grup-form dflx">
                        ...
                        <div class="boxform">
                            ...
                            <input v-model="added.email" type="email" id="email" name="email"  required class="in1">
                        </div>
                    </div>
             ...
             if(pass === passc){
                  let user ={
                    ...
                    "role":role,
                        ...
                        let result = await this.$store.dispatch("usuarios/editItemUsr",  {option:'user', item: user});
     ...
     submitImg: async function (image) {
       ...
       if(image !=null){
           if(image.size > 5000000){
                ...
                let result = await   this.$store.dispatch("main/editImage", {id:this.added.id, item:data, option:'user'});
                console.log(result)
